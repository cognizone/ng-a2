...
describe('ServerFileBrowserComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CommonModule, NoopAnimationsModule, FormsModule, MatButtonModule, MatInputModule, MatCheckboxModule, MatExpansionModule],
      declarations: [ServerFileBrowserComponent, CmdlineComponent],
      providers: [{ provide: ServerFileBrowserService, useClass: ServerFileBrowserServiceMock }],
    }).compileComponents();
  });

...
```bash
cd ./projects/cognizone/a2-core
npm link
cd /path/to/my/project/frontend/root
npm link @cognizone/a2-core
```

With this, the installed dependency of @cognizone/a2-core will be replaced a symlink to the source present here. But keep in mind:
...
```bash
npm unlink @cognizone/a2-core
```

### Changing "dest" for build usage in project

in `projects/cognizone/a2-core/ng-package.json`, there is the `dest` attribute, you can change this path to something like `/path/to/my/project/frontend/root/node_modules/@cognizone/a2-core`. After that you can run
